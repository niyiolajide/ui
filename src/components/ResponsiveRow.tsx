 ...
 */
export default function ResponsiveRow({ align = 'start', className, children, ...rest }: ResponsiveRowProps) {
  return (
    <div className={cn('responsive-row', align === 'center' && 'responsive-row-center', className)} {...rest}>
      {children}
    </div>
  )
}
